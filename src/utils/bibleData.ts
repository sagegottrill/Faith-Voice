...
export const BIBLE_BOOKS = [
  ...
  { name: 'First Corinthians', abbr: ['1cor', '1co', 'first corinthians', '1 corinthians'], chapters: 16 },
  { name: 'Second Corinthians', abbr: ['2cor', '2co', 'second corinthians', '2 corinthians'], chapters: 13 },
  ...
  { name: 'First Thessalonians', abbr: ['1thess', '1th', 'first thessalonians', '1 thessalonians'], chapters: 5 },
  { name: 'Second Thessalonians', abbr: ['2thess', '2th', 'second thessalonians', '2 thessalonians'], chapters: 3 },
  { name: 'First Timothy', abbr: ['1tim', '1ti', 'first timothy', '1 timothy'], chapters: 6 },
  { name: 'Second Timothy', abbr: ['2tim', '2ti', 'second timothy', '2 timothy'], chapters: 4 },
  ...
  { name: 'First Peter', abbr: ['1pet', '1pe', '1pt', 'first peter', '1 peter'], chapters: 5 },
  { name: 'Second Peter', abbr: ['2pet', '2pe', '2pt', 'second peter', '2 peter'], chapters: 3 },
  { name: 'First John', abbr: ['1john', '1jn', '1jo', 'first john', '1 john'], chapters: 5 },
  { name: 'Second John', abbr: ['2john', '2jn', '2jo', 'second john', '2 john'], chapters: 1 },
  { name: 'Third John', abbr: ['3john', '3jn', '3jo', 'third john', '3 john'], chapters: 1 },
